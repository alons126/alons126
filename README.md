...
Physics PhD student focused on **scientific software, simulation, and collaborative development**.
...
**Production geometry implementation merged into an international simulation framework**

- Implemented Ar, C, and Sn target geometries and configurations
- Code merged into the official repository via PR #64
...
- Identified a bug where GENIE (v3.2) generated only 1n1p final states for 2p2h SuSA-MEC
